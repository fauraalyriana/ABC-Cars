...
public class Car {
	...
	public Car(Long id, String photos, String photoImagePath, String name, String make, String model,
			String registeration, String price, String Mileage, String plate, String transmission, String location, Long sellerId) {
		super();
		this.id = id;
		this.photos = photos;
	...
	public String toString() {
		return "Car [id=" + id + ", photos=" + photos + ", photoImagePath=" + photoImagePath + ", name=" + name
				...
				+ ", Mileage=" + Mileage + ", plate=" + plate + ", transmission=" + transmission + ", location=" + location + ", sellerId=" + sellerId + ", postDate=" + postDate + "]";
	}
